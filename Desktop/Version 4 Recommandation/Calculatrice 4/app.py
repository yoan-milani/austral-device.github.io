...
# Fonction pour estimer la consommation
...
# Classe de recommandation photovoltaïque
class PVRecommender:
    def __init__(self):
    ...
    def recommend_pv(self, surface, consommation_mensuelle, budget):
        ...
        for panneau in self.panneaux:
            ...
            if nombre_panneaux > 0:
                ...
                production_annuelle = nombre_panneaux * panneau["puissance"] / 1000 * 12  # en kWh/an
                production_mensuelle = production_annuelle / 12  # en kWh/mois
        ...
        # Ajout des recommandations de centrales même si les panneaux ne répondent pas aux critères de surface ou de budget
